...
export default function DevicesPage() {
  ...
  // FE-058 FIX: Wrap loadDevices in useCallback so it's stable in useEffect deps
  ...
  // FE-058 FIX: Add loadDevices to useEffect dependency array
  useEffect(() => {
    loadDevices();
  }, [loadDevices]);
            ...
            {devices.map((device, i) => (
              ...
              >
                <div className="flex items-start justify-between mb-3">
                  ...
                  {/* FE-054 FIX: Add role="switch", aria-checked, tabIndex, and keyboard handler for accessibility */}
                  <div
                    role="switch"
                    aria-checked={device.state === 1}
                    ...
                    className={`w-10 h-6 rounded-full flex items-center transition-colors p-0.5 shrink-0 ml-2 ${
