...
bool telemetryEnqueue(const String& json) {
    if (telemetryQueueCount >= TELEMETRY_QUEUE_SIZE) {
        // T3-FW-006: Queue full — advance TAIL (read pointer) not HEAD
        // This drops the oldest entry that is about to be read next,
        // preserving the most recent data in the queue
...
void setup() {
    ...
    Serial.println("  Version 3.0.0 (Phase 3 Tahap 3 audit fixes)");
    Serial.println("========================================\n");
