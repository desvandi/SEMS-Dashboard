...
void SensorEngine::loop() {
    ...
    // T3-FW-021: Both micros() and _lastACSSample are unsigned long (32-bit on ESP32),
    //   which matches the lower 32 bits of micros(). Unsigned subtraction handles wrap-around.
    // -----------------------------------------------------------------------
