                      ...
                      {loading ? (
                        ...
                        <div className="relative">
                          <Input
                            ...
                            min={0}
                            max={
                              field.key === 'overvoltage_threshold' ? 40 :
                              field.key === 'low_battery_voltage' ? 30 :
                              field.key === 'overload_current' ? 100 :
                              field.key === 'telemetry_interval' ? 3600 :
                              field.key === 'config_sync_interval' ? 3600 :
                              field.key === 'sensor_failure_timeout' ? 300 : undefined
                            }
